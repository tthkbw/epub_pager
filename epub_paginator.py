...
parser.add_argument('--match',
                    ...
                    default=True)
parser.add_argument('--genplist',
                    help=('generate the navigation page list and page links '
                          'for page numbers'),
                    action=argparse.BooleanOptionalAction,
                    default=True)
parser.add_argument('--pgwords',
...
parser.add_argument('--epubcheck',
                    ...
                    default='none')
parser.add_argument('--chk_orig',
                    help='Run epubcheck on original file',
                    action=argparse.BooleanOptionalAction,
                    default='True')
parser.add_argument('--ebookconvert',

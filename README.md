...
* Pagelines and superscripts may have total page counts for the book and
  the current chapter.
...
display of your device given its size and the font size you have
...
displaying that information in an ereader that does not support
using that paging can also be useful.
...
example, 2-3), and also shows the line location of the page break with
...
1. External epubcheck is slow compared to epubpaginator. epubpaginator will
